...
from providers import ezrss, tvtorrents, kickass, nzbs_org, nzbmatrix, nzbsrus, newznab, womble, newzbin
...
def initialize(consoleLogging=True):
    ...
    with INIT_LOCK:
        ...
        global LOG_DIR, WEB_PORT, WEB_LOG, WEB_ROOT, WEB_USERNAME, WEB_PASSWORD, WEB_HOST, WEB_IPV6, USE_API, API_KEY, \
                ...
                NZBS, NZBS_UID, NZBS_HASH, EZRSS, TVTORRENTS, TVTORRENTS_DIGEST, TVTORRENTS_HASH, KICKASS, TORRENT_DIR, USENET_RETENTION, SOCKET_TIMEOUT, \
